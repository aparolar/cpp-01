...
/*   Updated: 2022/07/17 22:16:47 by aparolar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Karen::complain( std::string level )
{
	...
	switch (debugLevel)
	{
		case 0:	(this->*functionLevels[debugLevel++])();
		case 1:	(this->*functionLevels[debugLevel++])();
		case 2:	(this->*functionLevels[debugLevel++])();
		case 3:	(this->*functionLevels[debugLevel])();
		break;
	default:
